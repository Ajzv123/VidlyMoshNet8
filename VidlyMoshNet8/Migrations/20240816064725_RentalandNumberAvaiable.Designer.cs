...
namespace VidlyMoshNet8.Migrations
{
    ...
    [Migration("20240816064725_RentalandNumberAvaiable")]
    partial class RentalandNumberAvaiable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "799ed1f5-dc54-4459-b9cf-cbc4e74419f4",
                            ConcurrencyStamp = "799ed1f5-dc54-4459-b9cf-cbc4e74419f4",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "2ff420db-dae7-41f9-8d1c-24c6d9651056",
                            ConcurrencyStamp = "2ff420db-dae7-41f9-8d1c-24c6d9651056",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("VidlyMoshNet8.Models.Rental", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VidlyMoshNet8.Models.Rental", b =>
                {
                    b.HasOne("VidlyMoshNet8.Models.Customers", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VidlyMoshNet8.Models.Movie", "Movie")
                        .WithMany()
